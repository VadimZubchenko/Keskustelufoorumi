    ...
    <div class="row chat-wrap">
        ...
        <div class="col-sm-3 panel-wrap">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="#chat1" onclick="selectMessage(1)">Link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#chat2" onclick="selectMessage(2)">Link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" href="#" onclick="clearMessages()">Disabled</a>
                    </li>
                </ul>
                ...
                <div class="row send-wrap">
                    <div class="send-message">
                        ...
                        <div class="send-button">
                            <button type="button" class="btn btn-secondary btn-lg btn-block" onclick="sendMes()"> <i class="fa fa-send"></i></button>
                        </div>
                    </div>
                </div>
